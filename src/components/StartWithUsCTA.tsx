...
export default function StartWithUsCTA({ onOpenQuote }: StartWithUsCTAProps) {
  return (
    <section
      id="contact"
      className="relative w-full bg-[#1B2B3A] text-white py-24 sm:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden"
    >
      {/* Ambient background glows */}
      <div className="absolute top-0 right-0 w-96 sm:w-[550px] h-96 sm:h-[550px] bg-radial from-[#E07B10]/20 to-transparent rounded-full blur-3xl pointer-events-none -translate-y-1/2 translate-x-1/3" />
      <div className="absolute bottom-0 left-0 w-80 sm:w-[450px] h-80 sm:h-[450px] bg-radial from-[#E07B10]/10 to-transparent rounded-full blur-3xl pointer-events-none translate-y-1/2 -translate-x-1/4" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col">
            ...
            {/* Eyebrow */}
            <div className="inline-flex items-center gap-2 font-body text-xs tracking-[0.3em] uppercase font-bold text-[#E07B10] mb-4">
              <span className="w-2 h-2 rounded-full bg-[#E07B10] animate-pulse" />
              START WITH US • KSA FLEET PARTNER
            </div>

            {/* Headline */}
            <h2 className="font-display font-black text-4xl sm:text-6xl lg:text-7xl text-white uppercase tracking-tight leading-[0.92] mb-6">
              LET'S BUILD YOUR<br />
            ...
            {/* Subtitle */}
            <p className="font-body text-base sm:text-lg text-[#9CA3AF] max-w-xl leading-relaxed mb-8">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              ...
              {/* Button from Reference Screenshot 2: INQUIRE QUOTE */}
              <button
                type="button"
                onClick={onOpenQuote}
                className="group inline-flex items-center justify-center font-display font-bold text-sm sm:text-base tracking-[0.1em] uppercase text-[#1B2B3A] bg-white hover:bg-[#E07B10] hover:text-white hover:border-[#E07B10] px-8 sm:px-10 py-3.5 sm:py-4 rounded-full border-2 border-white shadow-[0_8px_25px_rgba(0,0,0,0.2)] transition-all duration-300 cursor-pointer"
              >
              ...
              <button
                type="button"
                onClick={onOpenQuote}
                className="group inline-flex items-center gap-2.5 font-display font-bold text-sm sm:text-base tracking-wider uppercase text-white hover:text-[#E07B10] px-6 py-3.5 rounded-full transition-colors cursor-pointer bg-transparent border border-white/20 hover:border-[#E07B10]"
              >
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            ...
            {/* Card 1: Headquarters */}
            <div className="bg-[#243447]/70 backdrop-blur-md rounded-2xl p-5 border border-white/10 flex items-start gap-4">
