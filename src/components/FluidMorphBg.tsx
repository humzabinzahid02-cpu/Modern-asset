...
/**
 * Modern Assets brand palette:
 * Interweaving Deep Industrial Navy, Vibrant Brand Gold/Amber,
 * Steel Slate, and Warm Sand contours for a unified, luxurious aesthetic.
 */
export const SITE_HERO_COLORS = [
  "#1B2B3A", // Deep Industrial Navy (Primary site heading/brand color)
  "#E07B10", // Vibrant Brand Amber / Golden Orange (Action button/accent)
  "#263A4D", // Steel Slate Navy
  "#F2EDE4", // Warm Sand / Cream contour
  "#0F1A24", // Midnight Navy (Deep heavy-duty contrast)
  "#E89E30", // Sunlit Warm Gold ribbon
  "#324B63", // Deep Oceanic Slate Blue
];
...
export function FluidMorphBg({
  ...
  // path[0]: original "d", path[1]: target morph shape
  const pathsData = [
    [
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          {/* Subtle directional drop shadow giving depth between navy and gold morphing layers */}
          <filter id="fluid-shadow" x="-8%" y="-8%" width="120%" height="120%">
            <feDropShadow
              dx="0"
              dy="6"
              stdDeviation="10"
        ...
        {pathsData.map((dList, index) => {
          // Each path gets a slight duration variation for more organic feel
